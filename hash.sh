...
parameters=`yad --borders=20 --width=300 --title="Hash Calculate" --item-separator="|" --separator="," --form \
    --field="Type:CB" --field="Save hash in one file:CHK" "^md5|sha256|sha1|sha224|sha384|sha512" TRUE`
